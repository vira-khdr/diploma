...
/***/ (function(module, exports, __webpack_require__) {
	...
	var XJSAddressParser    = __webpack_require__(5);
	var XJSFormulaEvaluatorFactory = __webpack_require__(6);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if ( false) {
	    var BackAddressConvertor = require('../BackAddressConvertor');
	    var BackFormulaConvertor = require('../BackFormulaConvertor');
	...
	XJSModelRunnerBase.prototype = {
	    ...
	    getCellValue: function(excelAddr) {
	        // console.log('excelAddr', excelAddr);
	        try {
	            var addr = this.addressParser.parse(excelAddr);
	    ...
	    checkValue: function(calcedVal, cell) {
	        if ( false) {
	            ...
	            if ( !isNaN(+oldVal) ) {
	                ...
	                var hasError = isNaN(delta) || isNaN(newVal) || delta > 0.01;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';
	var XJSFormulaEvaluator = __webpack_require__(7);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var XJSRangeBase = __webpack_require__(8);
	var ModelRange = __webpack_require__(9);
	    ...
	    evaluate: function(value, model, isDebug, parentOperation, storageForResultFlags) {
	        ...
	        if ( operation === OFFSET && this.runner) {
	            if (res[0] === REF) {
	                ...
	                throw "RANGES RETURN NOT SUPPORTED";
	            }
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function XJSRangeModel(args, model) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var functions=[];
	functions[0]=__webpack_require__(11);
	functions[1]=__webpack_require__(12);
	functions[2]=__webpack_require__(13);
	functions[3]=__webpack_require__(14);
	functions[4]=__webpack_require__(16);
	functions[5]=__webpack_require__(17);
	functions[6]=__webpack_require__(18);
	functions[7]=__webpack_require__(19);
	functions[8]=__webpack_require__(20);
	functions[9]=__webpack_require__(21);
	functions[10]=__webpack_require__(22);
	functions[11]=__webpack_require__(23);
	functions[12]=__webpack_require__(24);
	functions[13]=__webpack_require__(25);
	functions[14]=__webpack_require__(26);
	functions[15]=__webpack_require__(27);
	functions[16]=__webpack_require__(28);
	functions[17]=__webpack_require__(29);
	functions[18]=__webpack_require__(30);
	functions[19]=__webpack_require__(31);
	functions[20]=__webpack_require__(32);
	functions[21]=__webpack_require__(33);
	functions[22]=__webpack_require__(34);
	functions[23]=__webpack_require__(35);
	functions[24]=__webpack_require__(36);
	functions[25]=__webpack_require__(37);
	functions[26]=__webpack_require__(38);
	functions[27]=__webpack_require__(39);
	functions[28]=__webpack_require__(40);
	functions[29]=__webpack_require__(41);
	functions[30]=__webpack_require__(42);
	functions[31]=__webpack_require__(43);
	functions[32]=__webpack_require__(44);
	functions[33]=__webpack_require__(45);
	functions[34]=__webpack_require__(46);
	functions[35]=__webpack_require__(47);
	functions[36]=__webpack_require__(48);
	functions[37]=__webpack_require__(49);
	functions[38]=__webpack_require__(50);
	functions[39]=__webpack_require__(51);
	functions[40]=__webpack_require__(53);
	functions[41]=__webpack_require__(54);
	functions[42]=__webpack_require__(54);
	functions[43]=__webpack_require__(55);
	functions[44]=__webpack_require__(56);
	functions[45]=__webpack_require__(57);
	functions[46]=__webpack_require__(58);
	functions[47]=__webpack_require__(59);
	functions[48]=__webpack_require__(59);
	functions[49]=__webpack_require__(60);
	functions[50]=__webpack_require__(61);
	functions[51]=__webpack_require__(62);
	functions[52]=__webpack_require__(63);
	functions[53]=__webpack_require__(64);
	functions[54]=__webpack_require__(65);
	functions[55]=__webpack_require__(66);
	functions[56]=__webpack_require__(67);
	functions[57]=__webpack_require__(68);
	functions[58]=__webpack_require__(69);
	functions[59]=__webpack_require__(70);
	functions[60]=__webpack_require__(71);
	functions[61]=__webpack_require__(72);
	functions[62]=__webpack_require__(73);
	functions[63]=__webpack_require__(74);
	functions[64]=__webpack_require__(75);
	functions[65]=__webpack_require__(76);
	functions[66]=__webpack_require__(77);
	functions[67]=__webpack_require__(78);
	functions[68]=__webpack_require__(79);
	functions[69]=__webpack_require__(80);
	functions[71]=__webpack_require__(81);
	functions[72]=__webpack_require__(82);
	functions[70]=__webpack_require__(83);
	functions[74]=__webpack_require__(53);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	var XJSRange = __webpack_require__(9);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function(args, model, parentOperation) {
	    ...
	    var rows      = +args[1];
	    var cols      = +args[2];
	    var height    = args[3] ? +args[3] : false;
	    var width     = args[4] ? +args[4] : false;
	    ...
	    if ( height == 1 && width == 1 ) {
	        // if ( reference[SHEET] ==  12 && reference[START_COL] == 30 && reference[START_ROW] == 28 ) {
	            ...
	            // console.log('RETURN_FROM_OFFSET = ', ['=', sheetNum, startCol, startRow]);
	        // }

	        return [REF, sheetNum, startCol, startRow];
	    } else {

	        return new XJSRange([sheetNum, startCol, startRow, startCol+width-1, startRow+height-1], model); //TODO IS IT OK?
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var jStatModule = __webpack_require__(52).jStat;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function(args) {
	    ...
	    return jStatLocal.lognormal.inv(probability, mean, sd);
	}
